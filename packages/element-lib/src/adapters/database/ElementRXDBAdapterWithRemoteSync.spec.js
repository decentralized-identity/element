const ElementRXDBAdapterWithRemoteSync = require('./ElementRXDBAdapterWithRemoteSync');

let db;
const dbName = 'elementrxdb';

describe.skip('ElementRXDBAdapterWithRemoteSync', () => {
  beforeAll(async () => {
    db = new ElementRXDBAdapterWithRemoteSync({
      name: dbName,
      remote: 'https://USERNAME:PASSWORD@INSTANCE.cloudantnosqldb.appdomain.cloud/element-did/',
    });
  });
